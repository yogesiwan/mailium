...
A healthy HPA should report that it can scale and that its target metric is available. If demand exceeds the configured maximum, the HPA may legitimately report that scaling is limited by `maxReplicas`.
