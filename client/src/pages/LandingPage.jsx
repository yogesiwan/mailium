      ...
      <div className="w-full max-w-[1000px] bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 p-12 flex-col justify-between relative overflow-hidden text-white">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2">Email outreach, simplified</h1>
            <p className="text-indigo-200 text-sm font-medium">Build and manage personalized outreach at scale.</p>
          </div>

          <div className="relative z-10">
            <h2 className="text-4xl font-light leading-tight mb-4">
              One place to manage<br />
              <span className="font-medium">your email outreach.</span>
            </h2>
            <p className="text-indigo-200/80 text-sm max-w-sm leading-relaxed">
              Create campaigns, personalize messages, manage contacts, and automate
              your outreach with Gmail.
            </p>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm mx-auto">
            <div className="mb-10">
              ...
              <p className="text-sm text-gray-500">
                {isLogin ? 'Enter your details to access your dashboard.' : 'Create an account to start managing your campaigns.'}
              </p>
            </div>
